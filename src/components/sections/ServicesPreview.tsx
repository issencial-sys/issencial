          ...
          {services.map((service) => {
            ...
            return (
              <ChevronCard
                key={service.title}
                color={service.color}
                className="group overflow-hidden cursor-pointer transition-transform duration-300 hover:scale-[1.015]"
                contentClassName="flex-col items-start justify-center gap-1.5 py-4"
              >
